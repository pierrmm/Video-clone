  ...
  return (
    <SafeAreaView>
      <View style={tw`p-4 mx-5`}>
        <Text style={tw`text-2xl font-bold mb-2 text-center`}>Sign in to Vidio for free!</Text>
        ...
        <View style={tw`my-6`}>
          <ButtonPrimary title='Sign In' warnaBtn='[#ED205f]' warnaTxt='white' rute={() => { }} />
        </View>
        ...
        <View style={tw`flex justify-center mt-4`}>
          <Text style={tw`text-center text-sm text-gray-500`}>Don't have a Video account? <Text style={tw`text-blue-500`} onPress={() => navigation.push('/auth/signup')}>Sign Up</Text></Text>
        </View>
      </View>
    </SafeAreaView>
  )
